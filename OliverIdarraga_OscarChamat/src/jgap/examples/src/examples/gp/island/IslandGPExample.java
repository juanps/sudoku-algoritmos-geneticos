 ...
 */
package jgap.examples.src.examples.gp.island;
...
public class IslandGPExample {
  ...
  /**@todo Island config. einbauen, so dass Island model automatisch ausgef�hrt
   * wird
   */
  /**@todo impl. MergeEvent, e.g.: merge islands when one island stucks*/
  /**@todo jeweils beste l�sung geht �fters verloren! Beeinflusst ein Island das
   * andere oder ist die L�sung in einem Island nicht best�ndig?*/
