 ...
 */
package jgap.examples.src.examples.gp.paintedDesert;
...
public class X
   ...
   * @since 3.01
   */
  public X(final GPConfiguration a_conf)
      throws InvalidConfigurationException {
    super(a_conf, 0, CommandGene.IntegerClass);
  }

  public X(final GPConfiguration a_conf, final int a_subReturnType,
