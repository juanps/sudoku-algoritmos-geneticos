 ...
 */
package jgap.examples.src.examples.math.cmd;
...
public class MultiplyOperator
  ...
  public MultiplyOperator(Operand theLeft, Operand theRight) {
  ...
  public Object clone() {
    Operator op = new MultiplyOperator( (Operand)super.getLeftOperand().clone(),
